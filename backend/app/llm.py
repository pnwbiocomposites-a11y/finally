    ...
    messages: list[dict[str, str]] = [
        {
            ...
            "content": (
                ...
                "For BUY orders: always include the trade in the trades array when the user asks to buy. "
                "For SELL orders: check the account context positions first. Only include a sell trade if "
                "the user actually holds that ticker and has enough shares. If they don't hold it, explain "
                "that they have no position to sell instead of including the trade. "
